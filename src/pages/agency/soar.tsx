    ...
    <Wrapper header={<PageHeader title={title} backLinkLabel="Agency Work" backLinkRoute="/agency-work" />}>
      ...
      <article>
        ...
        <p>
          ...
          main website, ensuring content can be kept fresh and relevant with greater ease.</p>
        ...
        <p>
          ...
          customers through the use of marketing campaigns. The first step in this was to capture the details of everyone
          interested, which was achieved through a list of those willing to receive emails. My work for Soar also
          included building and managing their email campaigns through MailChimp’s email builder tools.
        </p>
        <p>
        ...
        <h3>Resources</h3>
        <ul>
          <li>The website can be found <a href="https://www.soarrunning.com" title="Soar Running's website" rel="external">here</a></li>
        </ul>
      </article>
    </Wrapper>
  )
