...
export default function Now() {
  return (
    <>
      ...
      <ul>
        <li>
          I have now obtained my open work permit for Canada and can start
          looking for new opportunities
        </li>
        <li>
          Unfortunately, I had to finish employment with{" "}
          <ExternalLink href="https://webflow.com" label="Webflow" />. They were
          fantastic in supporting my move to Canada but could only offer a
          90-day period where I could work for them without returning to the UK
        </li>
        <li>
          Took part in{" "}
          <ExternalLink
          ...
          <ul>
            ...
            <li>
              The game is called{" "}
              <ExternalLink
                href="https://globalgamejam.org/2023/games/couch-potato-1"
                label="Couch Potato"
              />{" "}
              and is based on{" "}
              <ExternalLink
                href="https://taskmaster.fandom.com/wiki/Get_this_potato_into_the_golf_hole"
                label="this segment of the show Taskmaster"
              />
            </li>
            <li>
              Essentially you have to throw a Potato into a small hole, the
              fastest wins
            </li>
          </ul>
        </li>
        <li>
          Continued my journey into{" "}
          <ExternalLink href="https://flutter.dev/" label="Flutter" />{" "}
          development
          <ul>
            <li>
              The project is called Pongstars and has been an on-and-off way of
              learning Flutter for several years
            </li>
            <li>
              The app aims to provide a method of tracking and recording Elo
              rankings for table-tennis leagues
            </li>
            <li>
              <ExternalLink href="https://supabase.com" label="Supabase" /> for
              Authentication, Postgres and Edge functions. Includes the ability
              to subscribe to changes in the database for real-time updates
            </li>
            <li>
              <ExternalLink
      ...
      <ul>
        <li>
          ...
          ever changing world of front-end development
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          Went for my first run in a long-time and impressed myself with a
          distance of 3km at a pace of 5m30s per km.
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          <ul>
            <li>
              Could go back to Rollerderby, I have purchased new safety
              equipment in preparation for this
            </li>
            <li>Could stick to regular roller-skating at rinks</li>
            <li>Join an Archery club</li>
            <li>More regular bouldering sessions</li>
            <li>
              Learn to ice skate, I did pick up a basic pair that I can use in
              the upcoming winter
            </li>
          </ul>
        </li>
